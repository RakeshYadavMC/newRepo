({
    ...
    addBottlePlateText: function(component, event, helper) {
        ...
        if (selectedItemsMap.hasOwnProperty('Bottle Plate City State Text')) {
            selectedItemsMap['Bottle Plate City State Text']['Insert_Text__c'] = component.get('v.citystateText');
        }
        component.set('v.selectedItemsMap', selectedItemsMap);
    },
    addCityStateText: function(component, event, helper) {
        //alert('addCityStateText');
        var selectedItemsMap = component.get('v.selectedItemsMap');
