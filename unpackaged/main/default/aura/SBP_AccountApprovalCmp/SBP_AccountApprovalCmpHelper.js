({
    ...
    onDistributorAccountChange: function(component, event, helper) {
        var distributorAccount = component.get('v.distributorAccountRecord');

        component.set('v.distributorAccount', distributorAccount.Id);
        component.set('v.company', distributorAccount.Name);
        component.set('v.distributorStreet', distributorAccount.BillingStreet);
        component.set('v.distributorCity', distributorAccount.BillingCity);
        component.set('v.distributorState', distributorAccount.BillingState);
        component.set('v.distributorZip', distributorAccount.BillingPostalCode);
        component.set('v.distributorPhone', distributorAccount.Phone);

        if (helper.isEmpty(distributorAccount)) {
            var contactLookup = component.find('distributor_contact');
            contactLookup.clearValue();
            component.set('v.distributorContactRecord', null);
            component.set('v.distributorContact', '');
        }
    },
    
    onContactLookupChange: function(component, event, helper) {
        var contactRecord = component.get('v.distributorContactRecord');
    ...
    submitApplicationWithExistingResponses: function(component, event, helper) {
        ...
        if (component.get('v.distributorAccountRecord')) {
            distributorAccountId = component.get('v.distributorAccountRecord').Id;
        }
    ...
    buildAccountApplication: function(component, event, helper) {
        console.log('inside buildAccountApplication Helper:::');
